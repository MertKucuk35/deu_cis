import 'package:deu_cis/feature/event_detail/subview/event_attendes_view.dart';
import 'package:deu_cis/product/vm/event_agenda_view_model.dart';
import 'package:deu_cis/feature/event_detail/subview/event_agenda_list_view.dart';
import 'package:deu_cis/feature/event_detail/subview/subview/event_speakers_view.dart';
import 'package:deu_cis/feature/event_detail/subview/event_home_view.dart';
...
class _EventDetailViewState extends State<EventDetailView>
  ...
  Future<void> _setup() async {
    ...
    await locator<EventInstitutionViewModel>().fetchEventInstitutions(eventID);
    setState(() {
      _isLoading = false;
    });
  }
