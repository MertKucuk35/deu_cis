...
class EventSponsorsListView extends StatelessWidget {
  const EventSponsorsListView({super.key});
      ...
      body: ChangeNotifierProvider.value(
          ...
          child: Consumer<EventInstitutionViewModel>(
            ...
            return ListView.builder(
              itemCount: eventInstitutionViewModel.eventSponsors?.length ?? 0,
              itemBuilder: (context, index) {
                return EventInstitutionsListItem(
                  eventInstitution:
                      eventInstitutionViewModel.eventSponsors![index],
                );
              },
            );
          })),
