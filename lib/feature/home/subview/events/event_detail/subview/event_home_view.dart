...
import 'package:deu_cis/feature/home/subview/events/event_detail/subview/widget/google_map_widget.dart';
...
class _describtion extends StatelessWidget {
  const _describtion({
    super.key,
  });
    ...
    if (selectedEvent != null && selectedEvent.description != null) {
      return Padding(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              _titleItem(title: StringConsts.footerDescTitle),
              Padding(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
          ...
          child: Column(
            children: [
              _titleItem(title: StringConsts.infBtnListTitle),
              Padding(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            _titleItem(title: StringConsts.adminTools),
            ListTile(
