...
class EventOrganizer extends BaseInstitution {
  EventOrganizer({
    required super.id,
  ...
  EventOrganizer.fromMap(Map<String, dynamic> json) {
    id = json['id'];
  ...
  factory EventOrganizer.fromJson(String source) =>
      EventOrganizer.fromMap(json.decode(source) as Map<String, dynamic>);
